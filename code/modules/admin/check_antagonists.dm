...
/datum/admins/proc/check_antagonists()
	if(!SSticker.HasRoundStarted())
		...
		return
	var/list/dat = list("<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>Round Status</title></head><body><h1><B>Round Status</B></h1>")eplacementmode)
